...
const initPage = () => {
    ...
    publishAnchor.setAttribute('href', `https://github.com/login/authorize?client_id=${GITHUB_CLIENT_ID}&scope=public_repo&state=${randomString}&
    redirect_uri=${window.origin}/webar/pages/publish-confirm/index.html`);
